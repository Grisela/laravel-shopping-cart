    ...
    <div class="collapse navbar-collapse" id="collapsibleNavId">
        <ul class="navbar-nav ml-auto mr-5 mt-2 mt-lg-0">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Cart <span class="badge badge-pill badge-danger">3</span></a>
                <div class="dropdown-menu mr-5" aria-labelledby="dropdownId">
                    ...
                    <div class="row detail">
                        <div class="col-4 section-image">
                            <img class='img-fluid' src="https://images-na.ssl-images-amazon.com/images/I/811OyrCd5hL._SX425_.jpg">
                        </div>
